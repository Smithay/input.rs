...
pub struct LibinputSeat<C: 'static, D: 'static, G: 'static, S: 'static>
{
...
impl<C: 'static, D: 'static, G: 'static, S: 'static> FromRaw<ffi::libinput_seat> for LibinputSeat<C, D, G, S>
{
    unsafe fn from_raw(raw: *mut ffi::libinput_seat) -> LibinputSeat<C, D, G, S>
    {
        LibinputSeat {
...
impl<C: 'static, D: 'static, G: 'static, S: 'static>  AsRaw<ffi::libinput_seat> for LibinputSeat<C, D, G, S>
{
...
impl<C: 'static, D: 'static, G: 'static, S: 'static>  Userdata<S> for LibinputSeat<C, D, G, S>
{
...
impl<C: 'static, D: 'static, G: 'static, S: 'static>  Clone for LibinputSeat<C, D, G, S>
{
    fn clone(&self) -> LibinputSeat<C, D, G, S>
    {
        LibinputSeat {
...
impl<C: 'static, D: 'static, G: 'static, S: 'static> Drop for LibinputSeat<C, D, G, S>
{
    fn drop(&mut self) {
        unsafe {
...
impl<C: 'static, D: 'static, G: 'static, S: 'static> LibinputSeat<C, D, G, S>
{
