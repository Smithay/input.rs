...
pub const libinput_pointer_axis_source_LIBINPUT_POINTER_AXIS_SOURCE_CONTINUOUS: libinput_pointer_axis_source = 3;
...
pub const libinput_tablet_pad_ring_axis_source_LIBINPUT_TABLET_PAD_RING_SOURCE_UNKNOWN: libinput_tablet_pad_ring_axis_source = 1;
pub const libinput_tablet_pad_ring_axis_source_LIBINPUT_TABLET_PAD_RING_SOURCE_FINGER: libinput_tablet_pad_ring_axis_source = 2;
pub type libinput_tablet_pad_ring_axis_source = ::libc::c_uint;
pub const libinput_tablet_pad_strip_axis_source_LIBINPUT_TABLET_PAD_STRIP_SOURCE_UNKNOWN: libinput_tablet_pad_strip_axis_source = 1;
pub const libinput_tablet_pad_strip_axis_source_LIBINPUT_TABLET_PAD_STRIP_SOURCE_FINGER: libinput_tablet_pad_strip_axis_source = 2;
...
pub const libinput_tablet_tool_proximity_state_LIBINPUT_TABLET_TOOL_PROXIMITY_STATE_OUT: libinput_tablet_tool_proximity_state = 0;
pub const libinput_tablet_tool_proximity_state_LIBINPUT_TABLET_TOOL_PROXIMITY_STATE_IN: libinput_tablet_tool_proximity_state = 1;
...
pub struct libinput_interface {
    ...
    pub open_restricted: ::std::option::Option<
        unsafe extern "C" fn(path: *const ::libc::c_char, flags: ::libc::c_int, user_data: *mut ::libc::c_void) -> ::libc::c_int,
    >,
    ...
    /// @param user_data The user_data provided in
    /// libinput_udev_create_context()
    pub close_restricted: ::std::option::Option<unsafe extern "C" fn(fd: ::libc::c_int, user_data: *mut ::libc::c_void)>,
}
#[test]
fn bindgen_test_layout_libinput_interface() {
    ...
    assert_eq!(
        unsafe { &(*(0 as *const libinput_interface)).open_restricted as *const _ as usize },
        0usize,
        concat!(
            "Alignment of field: ",
    ...
    assert_eq!(
        unsafe { &(*(0 as *const libinput_interface)).close_restricted as *const _ as usize },
        8usize,
        concat!(
            "Alignment of field: ",
            stringify!(libinput_interface),
...
pub type libinput_log_handler = ::std::option::Option<
    unsafe extern "C" fn(libinput: *mut libinput, priority: libinput_log_priority, format: *const ::libc::c_char, args: *mut __va_list_tag),
>;
extern "C" {
...
pub const libinput_config_drag_lock_state_LIBINPUT_CONFIG_DRAG_LOCK_DISABLED: libinput_config_drag_lock_state = 0;
pub const libinput_config_drag_lock_state_LIBINPUT_CONFIG_DRAG_LOCK_ENABLED: libinput_config_drag_lock_state = 1;
...
pub const libinput_config_send_events_mode_LIBINPUT_CONFIG_SEND_EVENTS_ENABLED: libinput_config_send_events_mode = 0;
pub const libinput_config_send_events_mode_LIBINPUT_CONFIG_SEND_EVENTS_DISABLED: libinput_config_send_events_mode = 1;
...
pub const libinput_config_accel_profile_LIBINPUT_CONFIG_ACCEL_PROFILE_ADAPTIVE: libinput_config_accel_profile = 2;
...
pub const libinput_config_click_method_LIBINPUT_CONFIG_CLICK_METHOD_BUTTON_AREAS: libinput_config_click_method = 1;
pub const libinput_config_click_method_LIBINPUT_CONFIG_CLICK_METHOD_CLICKFINGER: libinput_config_click_method = 2;
...
pub const libinput_config_middle_emulation_state_LIBINPUT_CONFIG_MIDDLE_EMULATION_DISABLED: libinput_config_middle_emulation_state = 0;
pub const libinput_config_middle_emulation_state_LIBINPUT_CONFIG_MIDDLE_EMULATION_ENABLED: libinput_config_middle_emulation_state = 1;
...
pub const libinput_config_scroll_method_LIBINPUT_CONFIG_SCROLL_ON_BUTTON_DOWN: libinput_config_scroll_method = 4;
