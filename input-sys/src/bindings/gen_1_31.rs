...
pub const libinput_switch_LIBINPUT_SWITCH_KEYPAD_SLIDE: libinput_switch = 3;
...
pub const libinput_plugin_system_flags_LIBINPUT_PLUGIN_SYSTEM_FLAG_NONE:
    libinput_plugin_system_flags = 0;
pub type libinput_plugin_system_flags = ::std::os::raw::c_uint;
extern "C" {
...
#[doc = " Drag is to be disabled, or is\n currently disabled."]
pub const libinput_config_3fg_drag_state_LIBINPUT_CONFIG_3FG_DRAG_DISABLED:
    libinput_config_3fg_drag_state = 0;
#[doc = " Drag is to be enabled for 3 fingers, or is\n currently enabled"]
pub const libinput_config_3fg_drag_state_LIBINPUT_CONFIG_3FG_DRAG_ENABLED_3FG:
    libinput_config_3fg_drag_state = 1;
#[doc = " Drag is to be enabled for 4 fingers, or is\n currently enabled"]
pub const libinput_config_3fg_drag_state_LIBINPUT_CONFIG_3FG_DRAG_ENABLED_4FG:
    libinput_config_3fg_drag_state = 2;
#[doc = " @ingroup config\n\n A config status to distinguish or set 3-finger dragging on a device.\n\n @since 1.27"]
pub type libinput_config_3fg_drag_state = ::std::os::raw::c_uint;
extern "C" {
